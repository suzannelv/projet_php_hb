...
<div class="bg-white dark:bg-gray-900 mx-auto">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-4 lg:gap-16">
        <div class="flex flex-col justify-center">
            ...
            <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Rejoignez-nous dans cette aventure linguistique où le rire, la découverte et l'apprentissage se rejoignent pour ouvrir des portes vers de nouvelles expériences.</p>
            <div class="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
                <a href="courses.php" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                    C'est parti
